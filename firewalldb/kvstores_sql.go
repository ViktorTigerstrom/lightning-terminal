...
type SQLMig6KVStoreQueries interface {
	...
	DeleteSessionKVStoreRecord(ctx context.Context, arg sqlcmig6.DeleteSessionKVStoreRecordParams) error
	...
	GetSessionKVStoreRecord(ctx context.Context, arg sqlcmig6.GetSessionKVStoreRecordParams) ([]byte, error)
	...
	UpdateSessionKVStoreRecord(ctx context.Context, arg sqlcmig6.UpdateSessionKVStoreRecordParams) error
